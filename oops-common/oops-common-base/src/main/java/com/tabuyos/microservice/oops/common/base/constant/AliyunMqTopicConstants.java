 ...
 *   <b>class: </b><i>AliyunMqTopicConstants</i>
 *   comment here.
 * </pre>
 *
 ...
 * </i></pre>
 * @version 0.1.0
 * @since 0.1.0 - 2/3/21 5:20 PM
 */
public class AliyunMqTopicConstants {

  private AliyunMqTopicConstants() {
  }
  ...
  private static String buildOpcConsumerTopics(List<TopicObj> topicList) {
    ...
    if (!CollectionUtils.isEmpty(topicList)) {
      for (TopicObj topicObj : topicList) {
        ...
        if (StrUtil.isEmpty(topic) || CollectionUtils.isEmpty(topicList)) {
          continue;
        }
  ...
  private static void trimEnd(StringBuilder stringBuilder, String suffix) {
    ...
    if (!StrUtil.isEmpty(suffix) && !str.endsWith(suffix)) {
      return;
    }
